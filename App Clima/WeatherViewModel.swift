...
final class WeatherViewModel : ObservableObject {
    ...
    func getWeather(city: String) async {
        let url = URL(string: "http://api.openweathermap.org/data/2.5/weather?q=Lima&appid=71c3e78149e90edcb26b5c8bf57708fa&units=metric&lang=es")! //Se añadio el parametro city para que coja el valor de la petición http
